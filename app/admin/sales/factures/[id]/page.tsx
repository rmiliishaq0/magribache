    ...
    return (
          <div className="flex flex-col gap-4 mb-4">
            <Card className="flex justify-between items-center gap-4 flex-row p-4">
              <h2 className="text-lg font-bold text-secondary">Modifier Un Facture</h2>
            ...
            >
              ...
              <ResizablePanel defaultSize="60%" className="w-full">
                <div ref={previewRef} className="flex h-full w-full justify-center p-4 w-full">
                  <DocPreview  docNumber={data?.docs?.numero} isFacture ={true} name={client.name} email={client.email} phone={client.phone} form={form}/>
                </div>
              </ResizablePanel>
            </ResizablePanelGroup>  
          </div>
