...
import DevisFormUpdate from "@/modules/devis/components/devis-form-update";
...
export default function Devis() {
    ...
    return (
       <Card>
            ...
            <TableCellViewerEntity  title={item?.reference || ""} item={item} setItem={setItem} link={`/admin/devis/${item?.reference}`} >
                {
                    item && <DevisFormUpdate item={{...item,client:item?.client?.reference}} setItem={setItem} />
                }
